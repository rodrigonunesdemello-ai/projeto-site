...
import { getRegion, regions } from '@/lib/data'
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-16 md:px-6 md:py-24">
            ...
            <div className="mt-8 flex flex-col items-center text-center">
              ...
              <p className="mt-4 max-w-xl text-pretty leading-relaxed text-muted-foreground">
                Escolha uma categoria e vote nos talentos que representam o melhor de{' '}
                {region.name}. Cada voto conta e concorre a prêmios exclusivos.
              </p>
            </div>
          </div>
        </section>

        {/* Card de Prêmio imponente (substitui o impacto social) */}
        <PrizeCard />

        {/* Categorias e concorrentes com modal de captura de leads */}
        <VotingSection categories={region.categories} />
      </main>
